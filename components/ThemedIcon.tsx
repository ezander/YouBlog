...
const mapMaterial: IconMap = {
  ...
  // log_in: "person", //{ name: "login", type: "material-community" },
  log_in: { name: "people", type: "simple-line-icon" },
  // log_in: "people", //{ name: "login", type: "material-community" },

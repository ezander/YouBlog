...
import { ErrorType, FirebaseError, HTTPError } from "./FirebaseTools";
    ...
    case 400:
      return new FirebaseError(
        ...
        ErrorType.INTERNAL_PROBLEM,
        {
          ...
          details:
            "The API call was incorrectly formatted" +
    ...
    case 401:
      return new FirebaseError(
        ...
        ErrorType.INVALID_DATA, // make this a subtype
        {
          ...
          details:
            "The API call needs authorisation and you didn't login or are not allowed to perform this request." +
            `${message} (${code} - ${fb_status})`,
          data: { config, data },
